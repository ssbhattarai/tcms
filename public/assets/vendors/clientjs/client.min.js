...
var deployJava = (function() {
    ...
    var p = "codebase code name archive object width height alt align hspace vspace"
            .split(" ")
            .concat(e),
        b;
    try {
    ...
    var c = {
        ...
        createWebStartLaunchButtonEx: function(a, b) {
            ...
            document.write(
                '<a href="' +
                    ("javascript:deployJava.launchWebStartApplication('" +
                        a +
                        "');") +
        ...
        testUsingPluginsArray: function(a) {
            ...
            for (
                ...
                if (
                    ...
                    -1 != s.search(/^Java/) &&
                    -1 != b.indexOf("win") &&
                    (this.compareVersions("1.5.0", a) ||
                        this.compareVersions("1.6.0", a))
                )
                    return !0;
...
function murmurhash3_32_gc(f, d) {
    ...
    b =
        (2246822507 * (b & 65535) +
            (((2246822507 * (b >>> 16)) & 65535) << 16)) &
        4294967295;
    b ^= b >>> 13;
    b =
        (3266489909 * (b & 65535) +
            (((3266489909 * (b >>> 16)) & 65535) << 16)) &
        4294967295;
    return (b ^ (b >>> 16)) >>> 0;
}
