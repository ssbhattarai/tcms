<footer class="footer-area bg-f7fafd">
                ...
                <div class="single-footer-widget">
                    ...
                    <ul class="footer-contact-info">
                        ...
                        <li>
                            ...
                            Email: <a
                                href="mailto:test@gmail.com"><span
                                    class="__cf_email__">test@gmail.com</span></a>
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            Phone: <a href="tel:+977987878787838">+977 987878787838</a>
                        </li>
                    </ul>
                    <ul class="social-links">
                        ...
                        <li>
                            <a class="twitter" target="_blank" href="/iot/#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path
                        ...
                        <li>
                            <a class="instagram" target="_blank" href="/iot/#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li>
                            <a class="linkedin" target="_blank" href="/iot/#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path
    ...
    <img src="{{ asset('frontend/images/map.png') }}" class="map" alt="map">
