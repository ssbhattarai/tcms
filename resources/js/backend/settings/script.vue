        ...
        <div class="add-blog mb-5 shadow p-3 " v-if="showAddForm">
            <div class="row">
                <div class="form-group col-12">
                    <label class="font-weight-bold">Script Name</label>
                    <input
                        class="form-control"
                        v-model="form.name"
                        type="text"
                ...
                <div class="form-group col-12">
                    <label class="font-weight-bold">Script Code</label>
                    <textarea
                        class="form-control"
                        v-model="form.script"
                        type="text"
...
export default {
    ...
    methods: {
        getData(page = 1) {
            axios.get("/admin/script/get-all?page=" + page).then(response => {
        ...
        submitForm() {
            ...
            formData.append("script", this.form.script);
            ...
            if (this.formState == "save") {
                axios.post("/admin/script", formData, config).then(response => {
        ...
        deleteItem(id) {
            ...
            if (confirm) {
                axios.delete("/admin/script/" + id).then(response => {
