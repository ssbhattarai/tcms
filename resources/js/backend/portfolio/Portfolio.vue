...
<div>
   ...
   <div class="card bg-secondary" v-if="showForm">
        ...
        <form @submit.prevent="validate().then(submitForm)">
            <div clas="row">
                <div class="col p-2">
                    <ValidationProvider rules="required" v-slot="{ errors }" slim name="Project Name">

                   <label for="project" class="form-control-label">Project Name</label>
                    <input type="text" class="form-control form-control-alternative "  placeholder="Project name" v-model="portfolio.title" id="project">
       ...
       <div class="row">
           <div class="col">
               <div class="p-2">
                <ValidationProvider rules="required" v-slot="{ errors }" slim name="client title">

                   <label for="title" class="form-control-label">Client Name</label>
                    <input type="text" class="form-control form-control-alternative "  placeholder="client name" v-model="portfolio.companyName" id="title">
                    <span class="help-text text-danger">{{ errors[0] }}</span>
                </ValidationProvider>
                </div>
           </div>
            ...
            <div class="col">
                ...
                <ValidationProvider rules="required" v-slot="{ errors }" slim name="category">
                        <div>
                            ...
                            <multiselect v-model="portfolio.category" tag-placeholder="Add this as new category"
                                placeholder="Search or add a category" label="title" track-by="id" :options="categories"
            ...
            <section>
                ...
                >
                    ...
                    <template #cell(status)="data">
                       <div>
                           <span class="text-green" v-if="data.item.status">Active</span>
    ...
    methods: {
        ...
        submitForm() {
            ...
            for (let i = 0; i < this.portfolio.image.length; i++) {
             ...
             let idofsubcat = [];
             if(this.portfolio.category.length > 0) {

                this.portfolio.category.map(data => {
                    idofsubcat.push(data);
                });
            }
            ...
            formData.append("category", JSON.stringify(idofsubcat));
        ...
        previewEditItem(item) {
            ...
            this.portfolio = item;
            console.log(item);
            this.portfolio.category = item.category;
            ...
            this.portfolio.category = JSON.parse(item.category);
